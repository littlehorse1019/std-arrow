...
public class ORMStore {
	 ...
	 */
	public static void addInOrmMap(String className, MappingRule mappingRule) throws Exception {

		logger.debug("加载类" + className + "和Database的Mapping关系...");
		try {
			Obj2TabContainer obj2TabMap = new Obj2TabContainer();
			obj2TabMap.loadMapping(className, mappingRule);

			Tab2ObjContainer tab2ObjMap = new Tab2ObjContainer();
			tab2ObjMap.loadMapping(className, mappingRule);

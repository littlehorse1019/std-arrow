package com.std.action;

import com.std.aop.BookFacade;
import com.std.bo.TestBo;
...
import com.std.intcept.ClassInterceptor1;
import com.std.intcept.ClassInterceptor2;
import com.std.intcept.MethodInterceptor1;
import com.std.intcept.MethodInterceptor2;
import com.std.ioc.IOCTest;
import com.std.job.TestJob;
...
public class ActionTest extends BaseAction {
    ...
    private List<TestBo> doTestModelView () {
        ...
        List<TestBo> testBoList = ModelHelper.findEntityListBySql(new TestBo(), "SELECT * FROM T_TEST_BO ", null);
